...
if __name__ == "__main__":
    ...
    experiment(training_set, test_set, 'svm-linear', OneVsRestClassifier(SVC(cache_size=60000, class_weight='balanced',
                                                                      probability=True, kernel='linear', C=10, verbose=2)))